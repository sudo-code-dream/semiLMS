    ...
    <section className='container space-y-16 py-24 mx-auto md:py-32'>
      <div className='mx-auto max-w-[58rem] text-center'>
        ...
        <p className='mt-4 text-muted-foreground sm:text-lg'>
          Discover how Fudemy can simplify your learning experience with our
          smart and easy to use LMS.
        </p>
      </div>
      <div className='mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-2'>
        {features.map((feature) => (
          <div
            key={feature.name}
            className='relative hover:scale-110 duration-300 ease-in-out transition-all  overflow-hidden rounded-lg border bg-background p-8'>
